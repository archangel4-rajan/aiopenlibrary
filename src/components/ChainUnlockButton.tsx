...
export default function ChainUnlockButton({
  chainSlug,
  zapPrice,
  creatorId,
  isPurchased,
  ...
  const handlePurchase = async () => {
    ...
    try {
      const res = await fetch(`/api/chains/${chainSlug}/purchase`, {
        method: "POST",
      });
      ...
      toast({ message: "Chain unlocked!", type: "success" });
      router.refresh();
    } catch (err) {
