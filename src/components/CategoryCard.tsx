...
export default function CategoryCard({ category }: CategoryCardProps) {
  return (
    <Link
      ...
      className="group flex items-center gap-4 rounded-lg border border-stone-200 bg-white p-4 transition-all hover:border-stone-300 hover:shadow-sm dark:border-stone-700 dark:bg-stone-800"
    >
