...
export default async function Home() {
  ...
  return (
    <div className="bg-stone-50">
      ...
      <section className="relative overflow-hidden border-b border-stone-200">
        <div className="relative mx-auto max-w-7xl px-4 pb-12 pt-12 sm:px-6 sm:pb-24 sm:pt-28 lg:px-8">
          <div className="text-center">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-stone-300 bg-white px-3 py-1 text-xs text-stone-600 sm:mb-6 sm:px-4 sm:py-1.5 sm:text-sm">
              <BookOpen className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
              Free and open source
            </div>
            <h1 className="mx-auto max-w-4xl text-3xl font-bold tracking-tight text-stone-900 sm:text-6xl lg:text-7xl">
              Get better results from{" "}
              <span className="gradient-text">every AI prompt</span>
            </h1>
            <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-stone-500 sm:mt-6 sm:text-xl">
            ...
            <div className="mt-8 flex flex-col items-center gap-3 sm:mt-10 sm:flex-row sm:justify-center sm:gap-4">
              <Link
                href="/categories"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-lg bg-stone-900 px-6 py-3 text-sm font-medium text-white transition-all hover:bg-stone-800"
              >
                Start Exploring
              ...
              <Link
                href="/submit"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-lg border border-stone-300 bg-white px-6 py-3 text-sm font-medium text-stone-700 transition-all hover:border-stone-400 hover:bg-stone-50"
              >
                Share a Prompt
              </Link>
            </div>
      ...
      {/* How It Works */}
      <section className="border-b border-stone-200 bg-white py-12 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-xs font-medium uppercase tracking-widest text-stone-400">
              How it works
            </h2>
            <p className="mt-2 text-xl font-bold text-stone-900 sm:text-3xl">
      ...
      {/* Categories */}
      <section className="border-b border-stone-200 py-12 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
